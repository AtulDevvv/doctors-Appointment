...
import { assets, specialityData } from '../assets/asset'
...
function SpecialityMenu() {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality'>
      ...
      <p className='sm:w-1/3 text-center text-sm'>  simply browse through our extensive list of trsuted doctors , schedule your appointment with the specilists</p>
